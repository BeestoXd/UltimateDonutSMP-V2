# Contributing to UltimateDonutSmp2

Thank you for your interest in contributing to **UltimateDonutSmp2**! We welcome bug reports, feature requests, documentation fixes, and pull requests from the community.

---

## Code of Conduct & Rules

- **Respect Licensing**: UltimateDonutSmp2 is released under a proprietary license. Contributions submitted to this repository become part of the project under its existing licensing terms. See [LICENSE.md](LICENSE.md).
...
- Search the existing [GitHub Issues](https://github.com/BeestoXd/UltimateDonutSMP-V2/issues) before opening a new one to avoid duplicates.
...
Thank you for helping make UltimateDonutSmp2 better!
