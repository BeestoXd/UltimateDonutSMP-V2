...
public class CrateRewardMenu extends BaseMenu {
    ...
    public CrateRewardMenu(UltimateDonutSmp2 plugin, CrateManager.CrateDefinition crate) {
        this(plugin, crate, OpenContext.COMMAND);
    }

    public CrateRewardMenu(UltimateDonutSmp2 plugin, CrateManager.CrateDefinition crate, OpenContext openContext) {
