...
import com.bx.ultimateDonutSmp2.models.PunishmentState;
...
public class PunishmentHistoryMenu extends BaseMenu {
    ...
    public PunishmentHistoryMenu(UltimateDonutSmp2 plugin, UUID targetUuid, boolean returnToProfileViewer) {
    ...
    private void buildFilterStateButton() {
        set(FILTER_STATE_SLOT, ItemUtils.createItem(
                ...
                replaceMenuPlaceholders(menus().getString(MENU_PATH + ".BUTTONS.FILTER-STATE.DISPLAY-NAME", "&eState filter")),
    ...
    private void buildFilterTypeButton() {
        set(FILTER_TYPE_SLOT, ItemUtils.createItem(
                ...
                replaceMenuPlaceholders(menus().getString(MENU_PATH + ".BUTTONS.FILTER-TYPE.DISPLAY-NAME", "&eType filter")),
                replaceMenuPlaceholders(defaultIfEmpty(
    ...
    private void buildRefreshButton() {
        set(REFRESH_SLOT, ItemUtils.createItem(
                ...
                replaceMenuPlaceholders(menus().getString(MENU_PATH + ".BUTTONS.REFRESH.DISPLAY-NAME", "&eRefresh")),
                replaceMenuPlaceholders(defaultIfEmpty(
