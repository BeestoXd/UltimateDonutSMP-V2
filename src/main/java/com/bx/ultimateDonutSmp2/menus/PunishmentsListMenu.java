...
public class PunishmentsListMenu extends BaseMenu {
    ...
    public PunishmentsListMenu(UltimateDonutSmp2 plugin) {
    ...
    public void build(Player player) {
        ...
        buildButton(FILTER_STATE_SLOT, "FILTER-STATE", "HOPPER", "&eState filter",
                List.of("&7Current: &f{state_filter}", "&aClick to change"));
        buildButton(FILTER_TYPE_SLOT, "FILTER-TYPE", "BOOK", "&eType filter",
                List.of("&7Current: &f{type_filter}", "&aClick to change"));
        buildButton(REFRESH_SLOT, "REFRESH", "CLOCK", "&eRefresh",
                List.of("&7Reload the punishment list."));
        buildButton(SEARCH_SLOT, "SEARCH", "NAME_TAG", "&eSearch",
                List.of("&7Current: &f{search}", "&aLeft-click to search a player", "&cRight-click to clear"));
        buildButton(SORT_SLOT, "SORT", "COMPARATOR", "&eSort",
