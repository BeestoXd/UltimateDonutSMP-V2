...
public class FeatureToggleMenu extends BaseMenu {
    ...
    public FeatureToggleMenu(UltimateDonutSmp2 plugin) {
        this(plugin, 0);
    }

    public FeatureToggleMenu(UltimateDonutSmp2 plugin, int page) {
    ...
    private static String configuredTitle(UltimateDonutSmp2 plugin, int page) {
        return plugin.getConfigManager().getMenus()
