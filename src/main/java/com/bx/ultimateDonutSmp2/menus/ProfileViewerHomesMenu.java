...
public class ProfileViewerHomesMenu extends BaseMenu {
    ...
    public ProfileViewerHomesMenu(UltimateDonutSmp2 plugin, UUID targetUuid, boolean returnToProfileViewer) {
    ...
    private static String configuredTitle(UltimateDonutSmp2 plugin, UUID uuid) {
