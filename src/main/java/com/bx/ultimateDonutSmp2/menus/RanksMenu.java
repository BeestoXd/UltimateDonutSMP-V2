...
public class RanksMenu extends BaseMenu {
    ...
    public RanksMenu(UltimateDonutSmp2 plugin) {
    ...
    private static List<RankButton> loadButtons(UltimateDonutSmp2 plugin, int inventorySize) {
    ...
    private static Material configuredFiller(UltimateDonutSmp2 plugin) {
