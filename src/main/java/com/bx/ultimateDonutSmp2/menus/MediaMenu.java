...
public class MediaMenu extends BaseMenu {
    ...
    public MediaMenu(UltimateDonutSmp2 plugin) {
    ...
    public void build(Player player) {
        ...
        String displayName = menus.getString(BUTTON_PATH + ".DISPLAY-NAME", "&eMedia rank");
    ...
    public void handleClick(int slot, Player player) {
        ...
        player.sendMessage(ColorUtils.toComponent("&eCreate a ticket in Discord to apply for media rank."));
    ...
    private static int configuredSlot(UltimateDonutSmp2 plugin, int inventorySize) {
    ...
    private static Material configuredMaterial(UltimateDonutSmp2 plugin) {
