...
import com.bx.ultimateDonutSmp2.menus.CrateRewardMenu.OpenContext;
...
public class CratesMenu extends BaseMenu {
    ...
    public CratesMenu(UltimateDonutSmp2 plugin) {
        super(
                plugin,
    ...
    private org.bukkit.inventory.ItemStack createSimpleItem(
        ...
        org.bukkit.inventory.ItemStack item = com.bx.ultimateDonutSmp2.utils.ItemUtils.createItem(
                display.material(),
        ...
        com.bx.ultimateDonutSmp2.utils.ItemUtils.addEnchantments(item, display.enchantments());
