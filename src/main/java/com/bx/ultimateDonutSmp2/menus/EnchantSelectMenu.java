...
import com.bx.ultimateDonutSmp2.managers.EnchantmentsManager.EnchantOption;
...
public class EnchantSelectMenu extends BaseMenu {
    ...
    public EnchantSelectMenu(UltimateDonutSmp2 plugin, Player player, Material material) {
