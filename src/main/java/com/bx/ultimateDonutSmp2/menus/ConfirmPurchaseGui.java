...
public final class ConfirmPurchaseGui extends BaseMenu {
    ...
    public ConfirmPurchaseGui(UltimateDonutSmp2 plugin, AuctionListing listing) {
    ...
    public void handleClick(int slot, Player player, ClickType clickType) {
        ...
        com.bx.ultimateDonutSmp2.managers.AuctionHouseManager manager = plugin.getAuctionHouseManager();
    ...
    private void reopen(Player player, boolean sound) {
        if (sound) {
