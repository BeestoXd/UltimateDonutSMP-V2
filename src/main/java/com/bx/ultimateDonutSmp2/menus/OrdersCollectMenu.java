...
public class OrdersCollectMenu extends BaseMenu {
    ...
    public OrdersCollectMenu(UltimateDonutSmp2 plugin, int page) {
        this(plugin, page, 0L);
    }

    public OrdersCollectMenu(UltimateDonutSmp2 plugin, int page, long orderId) {
    ...
    public void handleClick(int slot, Player player) {
        ...
        try {
            ...
            if (claim.refundClaim()) {
                ...
                OrdersMenuSupport.play(player, plugin, "ORDERS.REFUND");
            } else {
                player.sendMessage(ColorUtils.toComponent(plugin.getConfigManager().getMessageOrDefault(
                        "ORDERS.CLAIMED_ITEM",
