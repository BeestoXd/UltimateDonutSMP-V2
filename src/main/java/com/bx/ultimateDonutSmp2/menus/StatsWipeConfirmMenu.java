...
public class StatsWipeConfirmMenu extends BaseMenu {
    ...
    public StatsWipeConfirmMenu(UltimateDonutSmp2 plugin, StatsWipeManager.WipeTarget target) {
    ...
    private static String configuredTitle(UltimateDonutSmp2 plugin, StatsWipeManager.WipeTarget target) {
