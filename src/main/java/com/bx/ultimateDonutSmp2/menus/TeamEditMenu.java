...
public class TeamEditMenu extends BaseMenu {
    ...
    public TeamEditMenu(UltimateDonutSmp2 plugin, UUID targetUuid) {
        this(plugin, targetUuid, 0, TeamMenu.SortMode.DEFAULT, null);
    }

    public TeamEditMenu(UltimateDonutSmp2 plugin, UUID targetUuid, int returnPage, TeamMenu.SortMode returnSortMode) {
        this(plugin, targetUuid, returnPage, returnSortMode, null);
    }

    public TeamEditMenu(UltimateDonutSmp2 plugin, UUID targetUuid, int returnPage, TeamMenu.SortMode returnSortMode, String returnSearchQuery) {
