...
public class DuelListener implements Listener {
    ...
    public DuelListener(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public void onDamage(EntityDamageEvent event) {
        ...
        if (event.getCause() == EntityDamageEvent.DamageCause.FALL
                && plugin.getDuelManager().hasArenaSetting(uuid, com.bx.ultimateDonutSmp2.managers.DuelManager.ArenaSetting.NO_FALL_DAMAGE)) {
            event.setCancelled(true);
            return;
        }
    ...
    public void onFoodChange(FoodLevelChangeEvent event) {
        ...
        UUID uuid = player.getUniqueId();
        if (!plugin.getDuelManager().hasArenaSetting(uuid, com.bx.ultimateDonutSmp2.managers.DuelManager.ArenaSetting.NO_HUNGER)) {
            return;
        }
    ...
    public void onInventoryOpen(InventoryOpenEvent event) {
        ...
        com.bx.ultimateDonutSmp2.models.DuelMatch match = plugin.getDuelManager().getActiveMatch(uuid);
