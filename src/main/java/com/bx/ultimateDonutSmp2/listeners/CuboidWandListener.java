...
public class CuboidWandListener implements Listener {
    ...
    public CuboidWandListener(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (!PermissionUtils.has(player, "ultimatedonutsmp2.admin.cuboid")) {
            return;
        }
    ...
    public static void markAsCuboidWand(UltimateDonutSmp2 plugin, ItemStack item) {
    ...
    private static boolean hasWandMarker(ItemMeta meta) {
        UltimateDonutSmp2 instance = UltimateDonutSmp2.getInstance();
