...
public class PunishmentCommandAliasListener implements Listener {
    ...
    public PunishmentCommandAliasListener(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    public void onPlayerCommand(PlayerCommandPreprocessEvent event) {
        if (!plugin.getFeatureManager().isEnabled(com.bx.ultimateDonutSmp2.managers.FeatureManager.Feature.PUNISHMENTS)) {
            return;
        }
