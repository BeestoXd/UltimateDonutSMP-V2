...
public class WorthPacketDisplay implements Listener {
    ...
    public WorthPacketDisplay(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    // confirms with a lime pane, which worth.yml prices at 3, so the button read "$ 3"
    ...
    private void registerPacketListener() {
        final UltimateDonutSmp2 uds = plugin; // packetadapter has its own plugin field
