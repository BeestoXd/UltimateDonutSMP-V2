...
public class EnderChestListener implements Listener {
    ...
    public EnderChestListener(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean blockUnsafeInsert(InventoryClickEvent event) {
        ...
        if (plugin.getCrashProtectionManager()
                .validateOrNotify(player, candidate, com.bx.ultimateDonutSmp2.managers.CrashProtectionManager.Context.ENDER_CHEST)
                .allowed()) {
            return false;
        }
