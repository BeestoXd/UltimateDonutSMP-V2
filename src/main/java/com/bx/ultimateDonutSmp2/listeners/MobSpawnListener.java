...
import com.bx.ultimateDonutSmp2.utils.MobSpawnPolicy;
...
public class MobSpawnListener implements Listener {
    ...
    public MobSpawnListener(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    /**
     * Re-reads the cached settings only when {@link com.bx.ultimateDonutSmp2.managers.ConfigManager} swapped in a
