...
public class VaultEconomyHook extends AbstractEconomy {
    ...
    public VaultEconomyHook(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public String currencyNamePlural() {
        return plugin.getCurrencyManager().plural(com.bx.ultimateDonutSmp2.managers.CurrencyManager.CurrencyType.MONEY);
    }

    @Override
    public String currencyNameSingular() {
        return plugin.getCurrencyManager().singular(com.bx.ultimateDonutSmp2.managers.CurrencyManager.CurrencyType.MONEY);
    }
    ...
    private EconomyResponse toResponse(com.bx.ultimateDonutSmp2.models.EconomyTransactionResult result) {
        if (result.success()) {
