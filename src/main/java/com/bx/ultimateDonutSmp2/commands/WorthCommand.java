...
import com.bx.ultimateDonutSmp2.menus.WorthMenu;
...
public class WorthCommand implements CommandExecutor {
    ...
    public WorthCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (subcommand.equals("reload")) {
            if (!PermissionUtils.has(sender, "ultimatedonutsmp2.admin.worth")) {
