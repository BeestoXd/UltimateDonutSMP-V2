...
public class WarpManagerCommand implements CommandExecutor {
    ...
    private static final String WARP_MANAGER_PERMISSION = "ultimatedonutsmp2.admin.warpmanager";
    private static final String SET_WARP_PERMISSION = "ultimatedonutsmp2.admin.setwarp";
    private static final String DELETE_WARP_PERMISSION = "ultimatedonutsmp2.admin.delwarp";

    private final UltimateDonutSmp2 plugin;

    public WarpManagerCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
