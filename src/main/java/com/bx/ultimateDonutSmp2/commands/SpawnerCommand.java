...
public class SpawnerCommand implements CommandExecutor {
    ...
    private static final String ADMIN_PERMISSION = "ultimatedonutsmp2.admin.spawner";

    private final UltimateDonutSmp2 plugin;

    public SpawnerCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean sendUsage(CommandSender sender, String label) {
        sender.sendMessage(ColorUtils.toComponent("&8&m----------- &eSpawner &8&m-----------"));
