...
import com.bx.ultimateDonutSmp2.utils.PunishmentExemptPolicy;

import com.bx.ultimateDonutSmp2.UltimateDonutSmp2;
import com.bx.ultimateDonutSmp2.managers.PunishmentManager;
...
public class PunishmentCommand implements CommandExecutor {
    ...
    private static final String CREATE_PERMISSION = "ultimatedonutsmp2.staff.punishments.create";
    private static final String BAN_PERMISSION = "ultimatedonutsmp2.staff.punishments.ban";
    private static final String UNBAN_PERMISSION = "ultimatedonutsmp2.staff.punishments.unban";
    private static final String MUTE_PERMISSION = "ultimatedonutsmp2.staff.punishments.mute";
    private static final String VCMUTE_PERMISSION = "ultimatedonutsmp2.staff.vcmute";
    private static final String VCUNMUTE_PERMISSION = "ultimatedonutsmp2.staff.vcunmute";
    private static final String UNMUTE_PERMISSION = "ultimatedonutsmp2.staff.punishments.unmute";
    private static final String BLACKLIST_PERMISSION = "ultimatedonutsmp2.staff.punishments.blacklist";
    private static final String UNBLACKLIST_PERMISSION = "ultimatedonutsmp2.staff.punishments.unblacklist";
    ...
    public PunishmentCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
