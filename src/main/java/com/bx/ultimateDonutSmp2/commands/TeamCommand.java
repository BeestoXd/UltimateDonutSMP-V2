...
import com.bx.ultimateDonutSmp2.menus.TeamDisbandConfirmMenu;
import com.bx.ultimateDonutSmp2.menus.TeamInfoMenu;
import com.bx.ultimateDonutSmp2.menus.TeamMenu;
...
public class TeamCommand implements CommandExecutor {
    ...
    public TeamCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!plugin.getFeatureManager().isEnabled(com.bx.ultimateDonutSmp2.managers.FeatureManager.Feature.TEAMS)
                || !plugin.getConfigManager().isCommandEnabled("TEAM")) {
            player.sendMessage(ColorUtils.toComponent("&cTeams are currently disabled."));
            return true;
        }
