...
public class UltimateDonutSmp2Command implements CommandExecutor, TabCompleter {

    private static final String RELOAD_PERMISSION = "ultimatedonutsmp2.admin.reload";
    private static final String STATS_WIPE_PERMISSION = "ultimatedonutsmp2.admin.statswipe";
    private static final String OPTIMIZE_PERMISSION = "ultimatedonutsmp2.admin.optimize";
    private static final String SETUP_PERMISSION = "ultimatedonutsmp2.admin.setup";
    private static final String FEATURES_PERMISSION = "ultimatedonutsmp2.admin.features";
    ...
    public UltimateDonutSmp2Command(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private void handleReload(CommandSender sender) {
        ...
        try {
            ...
            sender.sendMessage(ColorUtils.toComponent("&aUltimateDonutSMP2 configuration reloaded."));
        } catch (Exception exception) {
            plugin.getLogger().log(Level.SEVERE, "failed to reload ultimatedonutsmp2 configuration.", exception);
    ...
    private void sendSetupStatus(CommandSender sender, String label) {
        ...
        sender.sendMessage(ColorUtils.toComponent("&8&m---------- &bUltimateDonutSMP2 setup &8&m----------"));
    ...
    private List<String> commandNamesForCategory(String category, Collection<String> allCommandNames) {
        ...
        return switch (category) {
            ...
            case "market" -> List.of(
                    "auctionhouse", "orders", "bounty", "crate", "crates", "keys", "spawner"
            );
            case "pvp" -> List.of(
            ...
            case "admin" -> List.of(
                    "ultimatedonutsmp2", "clearlag", "cuboid", "setwarp", "delwarp", "warpmanager",
