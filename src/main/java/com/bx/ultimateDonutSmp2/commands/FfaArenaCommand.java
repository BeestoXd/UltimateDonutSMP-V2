...
import com.bx.ultimateDonutSmp2.managers.FfaManager;
...
public class FfaArenaCommand implements CommandExecutor {
    ...
    public FfaArenaCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean handle(CommandSender sender, String baseLabel, String[] args) {
        if (!PermissionUtils.has(sender, "ultimatedonutsmp2.admin.ffa")) {
        ...
        if (subcommand.equals("setspawn1") || subcommand.equals("setspawn2") || subcommand.equals("setreturn")) {
            sender.sendMessage(ColorUtils.toComponent(
                    "&eFFA arenas no longer use manual spawns. Use &f/" + baseLabel + " setpos <id> &eto set the combat arena center."
            ));
            return true;
        }
        ...
        if (subcommand.equals("setpos") || subcommand.equals("setpos1") || subcommand.equals("setpos2")) {
            ...
            sender.sendMessage(ColorUtils.toComponent(
                    "&aSet FFA arena center for &f" + id + "&a. &7Combat area and rollback will be built automatically from this point."
            ));
            return true;
        }
