...
public class ShardsCommand implements CommandExecutor {
    ...
    private static final String ADMIN_PERMISSION = "ultimatedonutsmp2.admin.shards";

    private final UltimateDonutSmp2 plugin;

    public ShardsCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private void sendEverywhereStatus(CommandSender sender, Player target, boolean debug) {
        ...
        if (debug) {
            ...
            sender.sendMessage(ColorUtils.toComponent("&7Current "
                    + plugin.getCurrencyManager().plural(com.bx.ultimateDonutSmp2.managers.CurrencyManager.CurrencyType.SHARDS)
