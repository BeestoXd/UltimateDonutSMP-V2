...
import com.bx.ultimateDonutSmp2.menus.DisguiseAliasMenu;
import com.bx.ultimateDonutSmp2.menus.DisguiseSkinMenu;
import com.bx.ultimateDonutSmp2.menus.HideListMenu;
import com.bx.ultimateDonutSmp2.menus.HideMenu;
...
public class HideCommand implements CommandExecutor, TabCompleter {
    ...
    public HideCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public void sendResult(CommandSender sender, HideManager.Result result) {
        ...
        switch (result.type()) {
            case SUCCESS -> {
                ...
                String key = result.state().mode() == com.bx.ultimateDonutSmp2.models.HideMode.SCRAMBLE
                        ? "SCRAMBLED"
                        : "DISGUISED";
