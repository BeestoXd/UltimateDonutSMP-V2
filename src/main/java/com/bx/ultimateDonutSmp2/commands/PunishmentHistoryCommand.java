...
import com.bx.ultimateDonutSmp2.menus.PunishmentHistoryMenu;
import com.bx.ultimateDonutSmp2.menus.PunishmentsListMenu;
...
public class PunishmentHistoryCommand implements CommandExecutor {
    ...
    public PunishmentHistoryCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
