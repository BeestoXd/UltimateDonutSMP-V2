...
import com.bx.ultimateDonutSmp2.managers.MaintenanceManager;
...
public class MaintenanceCommand implements CommandExecutor, TabCompleter {
    ...
    public MaintenanceCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    /**
     * The body of /maintenance. The /ultimatedonutsmp2 maintenance alias calls this with its own
     ...
     */
    static void handle(UltimateDonutSmp2 plugin, CommandSender sender, String usage, String[] args) {
        if (!sender.hasPermission("ultimatedonutsmp2.admin.maintenance")) {
        ...
        switch (args[0].toLowerCase(Locale.ROOT)) {
            ...
            case "status" -> {
                ...
                sender.sendMessage(ColorUtils.toComponent("&e&lMaintenance status:"));
