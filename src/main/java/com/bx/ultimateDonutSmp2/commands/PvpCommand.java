...
import com.bx.ultimateDonutSmp2.managers.PvpManager;
import com.bx.ultimateDonutSmp2.menus.PvpAssignMatchMenu;
import com.bx.ultimateDonutSmp2.menus.PvpKitEditMenu;
import com.bx.ultimateDonutSmp2.menus.PvpLeaderboardMenu;
import com.bx.ultimateDonutSmp2.menus.PvpMatchHistoryMenu;
import com.bx.ultimateDonutSmp2.menus.PvpQueueMenu;
import com.bx.ultimateDonutSmp2.models.PvpKit;
import com.bx.ultimateDonutSmp2.models.PvpRank;
import com.bx.ultimateDonutSmp2.models.PvpStats;
...
public class PvpCommand implements CommandExecutor, TabCompleter {
    ...
    public PvpCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private void applyKitProperty(CommandSender sender, PvpManager pvp, PvpKit kit, String action, String value) {
        switch (action) {
            case "icon" -> {
                org.bukkit.Material material = com.bx.ultimateDonutSmp2.utils.ItemUtils.parseMaterial(value);
                if (material == null) {
    ...
    private boolean isAdmin(CommandSender sender) {
        return PermissionUtils.has(sender, "ultimatedonutsmp2.admin.pvp");
    }
