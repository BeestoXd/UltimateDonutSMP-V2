...
import com.bx.ultimateDonutSmp2.managers.SpawnStashManager;
...
public class SpawnStashCommand implements CommandExecutor, TabCompleter {
    ...
    public SpawnStashCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
