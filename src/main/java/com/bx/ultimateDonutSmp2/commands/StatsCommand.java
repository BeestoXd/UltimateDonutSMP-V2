...
public class StatsCommand implements CommandExecutor {
    ...
    public StatsCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            if (plugin.getDialogManager() != null && plugin.getDialogManager().openStats(player)) {
                return true;
            }
        ...
        if (sender instanceof Player player) {
            if (plugin.getDialogManager() != null && plugin.getDialogManager().openStats(player, targetName)) {
                return true;
            }
