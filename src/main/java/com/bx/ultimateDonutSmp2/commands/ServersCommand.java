...
import com.bx.ultimateDonutSmp2.menus.ServersMenu;
...
public class ServersCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "ultimatedonutsmp2.servers";

    private final UltimateDonutSmp2 plugin;

    public ServersCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
