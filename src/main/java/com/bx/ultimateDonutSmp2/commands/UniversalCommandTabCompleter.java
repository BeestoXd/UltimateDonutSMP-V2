...
import com.bx.ultimateDonutSmp2.models.DuelArena;
...
public class UniversalCommandTabCompleter implements TabCompleter {
    ...
    public UniversalCommandTabCompleter(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        return switch (commandName) {
            ...
            case "enderchest" -> completeReloadOnly(sender, args, "ultimatedonutsmp2.admin.enderchest");
            ...
            case "freeze" -> completePlayerOrReload(sender, args, "ultimatedonutsmp2.admin.freeze", false);
            case "fly", "heal", "feed" -> completeOnlinePlayer(args, sender, true);
            case "flyspeed" -> completeFlySpeed(args, sender);
            case "staffmode" -> completePlayerOrReload(sender, args, "ultimatedonutsmp2.admin.staffmode", true);
            ...
            case "randomteleport", "leave", "draw", "pm", "spawn", "afk", "sell", "sellall", "sellhistory",
                    ...
                    "discord", "twitter", "store", "social", "rules", "ranks", "help", "servers",
                    "clearlag", "crates", "keys" -> List.of();
            case "teleport" -> completeTeleport(sender, label, args);
            case "invsee" -> completePlayerOrReload(sender, args, "ultimatedonutsmp2.admin.invsee", false);
    ...
    private List<String> completeOrders(CommandSender sender, String[] args) {
        ...
        if (has(sender, "ultimatedonutsmp2.admin.orders")) {
            options.add("reload");
        }
    ...
    private List<String> completeDuel(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "ultimatedonutsmp2.admin.duels")) {
                options.add("reload");
            }
            return partial(args[0], options);
        }
    ...
    private List<String> completeFfa(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "ultimatedonutsmp2.admin.ffa")) {
                options.add("arena");
                options.add("reload");
            }
            return partial(args[0], options);
    ...
    private List<String> completeAuctionHouse(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "ultimatedonutsmp2.admin.auctionhouse")) {
                options.add("reload");
            }
            return partial(args[0], options);
        }
    ...
    private List<String> completeWorth(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (has(sender, "ultimatedonutsmp2.admin.worth")) {
                options.add("reload");
            }
    ...
    private List<String> completeShards(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "ultimatedonutsmp2.admin.shards")) {
                options.add("everywhere");
            }
            return partial(args[0], options);
        }
        if (!normalize(args[0]).equals("everywhere") || !has(sender, "ultimatedonutsmp2.admin.shards")) {
            return List.of();
        }
        if (args.length == 2) {
    ...
    private List<String> completeSpawner(CommandSender sender, String[] args) {
        boolean admin = has(sender, "ultimatedonutsmp2.admin.spawner");
        if (args.length == 1) {
    ...
    private List<String> completeCuboid(CommandSender sender, String[] args) {
        if (!has(sender, "ultimatedonutsmp2.admin.cuboid")) {
            return List.of();
        }
        if (args.length == 1) {
    ...
    private List<String> completeShop(CommandSender sender, String[] args) {
        return completeReloadOnly(sender, args, "ultimatedonutsmp2.admin.shop");
    }
