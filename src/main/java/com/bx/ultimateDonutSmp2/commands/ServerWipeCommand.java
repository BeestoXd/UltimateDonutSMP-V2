...
import com.bx.ultimateDonutSmp2.managers.ServerWipeManager;
...
public class ServerWipeCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "ultimatedonutsmp2.admin.serverwipe";
    private static final List<String> SUBCOMMANDS = List.of("preview", "prepare", "confirm", "cancel", "status");

    private final UltimateDonutSmp2 plugin;

    public ServerWipeCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
