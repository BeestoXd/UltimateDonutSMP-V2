...
import com.bx.ultimateDonutSmp2.listeners.CuboidWandListener;
...
public class CuboidCommand implements CommandExecutor {
    ...
    public CuboidCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }

    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (!PermissionUtils.has(sender, "ultimatedonutsmp2.admin.cuboid")) {
