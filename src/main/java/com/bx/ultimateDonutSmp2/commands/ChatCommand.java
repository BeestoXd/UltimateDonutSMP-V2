...
public class ChatCommand implements CommandExecutor {
    ...
    private static final String BASE_PERMISSION = "ultimatedonutsmp2.staff.chat.use";
    private static final String MUTE_PERMISSION = "ultimatedonutsmp2.staff.chat.mute";
    private static final String UNMUTE_PERMISSION = "ultimatedonutsmp2.staff.chat.unmute";
    private static final String DELAY_PERMISSION = "ultimatedonutsmp2.staff.chat.delay";
    private static final String CLEAR_PERMISSION = "ultimatedonutsmp2.staff.chat.clear";

    private final UltimateDonutSmp2 plugin;

    public ChatCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
