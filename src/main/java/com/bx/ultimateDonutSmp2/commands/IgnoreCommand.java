...
import com.bx.ultimateDonutSmp2.managers.IgnoreManager;
...
public class IgnoreCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "ultimatedonutsmp2.ignore";

    private final UltimateDonutSmp2 plugin;

    public IgnoreCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
