...
import com.bx.ultimateDonutSmp2.managers.DatabaseManager;
...
public class SellStatsCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "ultimatedonutsmp2.admin.sellstats";

    private final UltimateDonutSmp2 plugin;

    public SellStatsCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }

    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!PermissionUtils.has(sender, PERMISSION) && !sender.hasPermission("ultimatedonutsmp2.admin")) {
        ...
        switch (sub) {
            ...
            case "web", "site", "url", "paste" -> new com.bx.ultimateDonutSmp2.managers.SellStatsExporter(plugin).uploadToWebPaste(sender);
            case "html" -> new com.bx.ultimateDonutSmp2.managers.SellStatsExporter(plugin).exportHtml(sender);
    ...
    private void handleReset(CommandSender sender, String[] args) {
        ...
        if (sender instanceof Player player) {
            new com.bx.ultimateDonutSmp2.menus.StatsWipeConfirmMenu(plugin, com.bx.ultimateDonutSmp2.managers.StatsWipeManager.WipeTarget.SELL_DOCUMENTS).open(player);
        } else {
