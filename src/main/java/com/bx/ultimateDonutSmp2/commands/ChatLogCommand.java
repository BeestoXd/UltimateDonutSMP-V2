...
import com.bx.ultimateDonutSmp2.menus.ChatLogsMenu;
...
public class ChatLogCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "ultimatedonutsmp2.admin.chatlog";

    private final UltimateDonutSmp2 plugin;

    public ChatLogCommand(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
