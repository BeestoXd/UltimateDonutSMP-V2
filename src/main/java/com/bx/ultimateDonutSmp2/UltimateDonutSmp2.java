package com.bx.ultimateDonutSmp2;

import com.bx.ultimateDonutSmp2.amethyst.*;
import com.bx.ultimateDonutSmp2.api.EconomyExpansion;
import com.bx.ultimateDonutSmp2.api.EconomyLeaderboardExpansion;
import com.bx.ultimateDonutSmp2.api.EconomyRankExpansion;
import com.bx.ultimateDonutSmp2.api.HideExpansion;
import com.bx.ultimateDonutSmp2.api.PvpExpansion;
import com.bx.ultimateDonutSmp2.api.UltimateDonutSmp2Expansion;
import com.bx.ultimateDonutSmp2.api.UdsExpansion;
import com.bx.ultimateDonutSmp2.commands.*;
import com.bx.ultimateDonutSmp2.hooks.VaultEconomyHook;
import com.bx.ultimateDonutSmp2.listeners.*;
import com.bx.ultimateDonutSmp2.managers.*;
import com.bx.ultimateDonutSmp2.tasks.*;
import com.bx.ultimateDonutSmp2.utils.ColorUtils;
import com.bx.ultimateDonutSmp2.utils.PlayerSettingDefaults;
...
public final class UltimateDonutSmp2 extends JavaPlugin {

    private static UltimateDonutSmp2 instance;
    ...
    private JoinSessionPreloader joinSessionPreloader;
    private StartupJoinWarmup startupJoinWarmup;
    private MovementChunkWarmup movementChunkWarmup;
    ...
    private BalancedPriceManager balancedPriceManager;
    ...
    private PlayerSettingToggles playerSettingToggles;
    /** Null on a server without the 1.21.6 dialog API; every caller checks before use. */
    private com.bx.ultimateDonutSmp2.dialogs.DialogManager dialogManager;
    private com.bx.ultimateDonutSmp2.menus.MenuNavigationTracker menuNavigationTracker;
    ...
    public void onEnable() {
        ...
        menuNavigationTracker = new com.bx.ultimateDonutSmp2.menus.MenuNavigationTracker(this);
        ...
        joinSessionPreloader = new JoinSessionPreloader(this);
        PlayerSettingDefaults.initialize();
        ...
        playerSkinManager = new PlayerSkinManager(this);
        playerSkinManager.loadCache();
        ...
        balancedPriceManager = new BalancedPriceManager(this);
        ...
        playerSettingToggles = new PlayerSettingToggles(this);
        if (com.bx.ultimateDonutSmp2.dialogs.DialogSupport.isAvailable()) {
            dialogManager = new com.bx.ultimateDonutSmp2.dialogs.DialogManager(this);
            dialogManager.refreshPauseScreen();
        }
        ...
        if (getServer().getPluginManager().isPluginEnabled("PlaceholderAPI")) {
            ...
            new UltimateDonutSmp2Expansion(this).register();
        ...
        com.bx.ultimateDonutSmp2.managers.SellStatsExporter.startEmbeddedHttpServer(this);

        syncCommands();
        startupJoinWarmup = new StartupJoinWarmup(this);
        startupJoinWarmup.start();
    ...
    public void onDisable() {
        ...
        if (joinSessionPreloader != null) {
            joinSessionPreloader.clear();
        }
        if (startupJoinWarmup != null) {
            startupJoinWarmup.shutdown();
        }
        if (teleportManager != null) {
            teleportManager.restoreAllRtpChunkThrottles();
        }
        if (rtpQueueManager != null) {
            rtpQueueManager.shutdown();
        }
        ...
        getLogger().info("UltimateDonutSmp2 disabled.");
    }
    ...
    private boolean checkPlaceholderApi() {
        ...
        getLogger().severe("====================================================");
        getLogger().severe("[UltimateDonutSmp2] ERROR: PlaceholderAPI is required to run this plugin!");
        getLogger().severe("[UltimateDonutSmp2] Please install PlaceholderAPI and restart your server.");
        getLogger().severe("[UltimateDonutSmp2] Disabling plugin...");
        getLogger().severe("====================================================");
        return false;
    }
    ...
    private void registerListeners() {
        ...
        pm.registerEvents(new EntityPressureListener(this), this);
        ...
        if (dialogManager != null) {
            pm.registerEvents(new com.bx.ultimateDonutSmp2.dialogs.DialogListener(this, dialogManager), this);
        }
    }
    ...
    private void registerCommands() {
        ...
        setExecutor("menu", new MenuCommand(this));
        ...
        amethystToolCommand.registerDynamicAliases();
        UltimateDonutSmp2Command ultimateDonutSmp2Command = new UltimateDonutSmp2Command(this);
        setExecutor("ultimatedonutsmp2", ultimateDonutSmp2Command);
        setTabCompleter("ultimatedonutsmp2", ultimateDonutSmp2Command);
    ...
    private boolean checkProtocolLibInstalled() {
        if (!getServer().getPluginManager().isPluginEnabled("ProtocolLib")) {
            getLogger().severe("====================================================");
            getLogger().severe("[UltimateDonutSmp2] ERROR: ProtocolLib is required to run this plugin!");
            getLogger().severe("[UltimateDonutSmp2] Please install ProtocolLib and restart your server.");
            getLogger().severe("[UltimateDonutSmp2] Disabling plugin...");
            getLogger().severe("====================================================");
            return false;
        }
    ...
    public void reloadAllPluginConfigurations() {
        ...
        if (balancedPriceManager != null) {
            balancedPriceManager.reload();
        }
        farmingMetaManager.load();
        ...
        com.bx.ultimateDonutSmp2.managers.SellStatsExporter.restartEmbeddedHttpServer(this);

        syncCommands();
    }

    public static UltimateDonutSmp2 getInstance() {
        return instance;
    }
    ...
    public PlayerSettingToggles getPlayerSettingToggles() {
        return playerSettingToggles;
    }

    /** Null when the server cannot render dialogs, so callers fall back to their chest menu. */
    public com.bx.ultimateDonutSmp2.dialogs.DialogManager getDialogManager() {
        return dialogManager;
    }

    public com.bx.ultimateDonutSmp2.menus.MenuNavigationTracker getMenuNavigationTracker() {
        return menuNavigationTracker;
    }
    ...
    public JoinSessionPreloader getJoinSessionPreloader() {
        return joinSessionPreloader;
    }

    public StartupJoinWarmup getStartupJoinWarmup() {
        return startupJoinWarmup;
    }

    public MovementChunkWarmup getMovementChunkWarmup() {
        return movementChunkWarmup;
    }
    ...
    public BalancedPriceManager getBalancedPriceManager() {
        return balancedPriceManager;
    }
