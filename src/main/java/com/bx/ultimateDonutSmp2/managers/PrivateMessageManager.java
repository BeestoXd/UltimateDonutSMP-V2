...
public class PrivateMessageManager {
    ...
    private static final String BYPASS_DISABLED_PERMISSION = "ultimatedonutsmp2.message.bypass-disabled";

    private final UltimateDonutSmp2 plugin;
    private final Map<UUID, UUID> replyTargets = new ConcurrentHashMap<>();

    public PrivateMessageManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean sendPrivateMessage(CommandSender sender, Player target, String message) {
        ...
        if (sender instanceof Player player) {
            ...
            if (targetData != null && !PermissionUtils.has(sender, BYPASS_DISABLED_PERMISSION)) {
                com.bx.ultimateDonutSmp2.models.ThreeChoice choice = targetData.getPrivateMessagesChoice();
                ...
                if (choice == com.bx.ultimateDonutSmp2.models.ThreeChoice.FRIENDS_FOLLOWED) {
