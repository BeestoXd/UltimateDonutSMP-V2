...
import com.bx.ultimateDonutSmp2.freeze.FreezeSession;
...
public class FreezeManager {
    ...
    public FreezeManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getStaffPermission() {
        return getConfig().getString("FREEZE.STAFF-PERMISSION", "ULTIMATEDONUTSMP2.STAFF.FREEZE");
    }

    public String getAlertPermission() {
        return getConfig().getString("FREEZE.ALERT-PERMISSION", "ULTIMATEDONUTSMP2.STAFF.FREEZE.ALERT");
    }

    public String getExemptPermission() {
        return getConfig().getString("FREEZE.EXEMPT-PERMISSION", "ULTIMATEDONUTSMP2.STAFF.FREEZE.EXEMPT");
    }

    public String getAdminPermission() {
        return getConfig().getString("FREEZE.ADMIN-PERMISSION", "ULTIMATEDONUTSMP2.ADMIN.FREEZE");
    }
