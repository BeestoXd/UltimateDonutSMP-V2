...
public class HideManager {
    ...
    public static final String SCRAMBLE_PERMISSION = "ultimatedonutsmp2.hide.scramble";
    public static final String DISGUISE_PERMISSION = "ultimatedonutsmp2.hide.disguise";
    public static final String ADMIN_PERMISSION = "ultimatedonutsmp2.hide.admin";
    public static final String BYPASS_PERMISSION = "ultimatedonutsmp2.hide.bypass";
    ...
    public HideManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    public void rememberState(HideState state) {
        if (state != null) {
            cache(state);
        }
    }
