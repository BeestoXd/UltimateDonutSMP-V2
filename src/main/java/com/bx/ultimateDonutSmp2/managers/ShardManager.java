...
public class ShardManager {
    ...
    public ShardManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    private void expireBooster(UUID uuid, boolean notifyPlayer) {
        ...
        player.sendMessage(com.bx.ultimateDonutSmp2.utils.ColorUtils.toComponent(expiredMessage));
    ...
    public String getEverywhereRequiredPermission() {
        return emptyToNull(plugin.getConfigManager().getConfig()
                .getString("SHARDS.EVERYWHERE.REQUIRED-PERMISSION", "ultimatedonutsmp2.shards.everywhere"));
    }
