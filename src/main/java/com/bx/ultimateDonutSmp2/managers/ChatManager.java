...
public class ChatManager {
    ...
    public ChatManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean isMuteBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "ultimatedonutsmp2.staff.chat.bypass.mute");
    }

    public boolean isDelayBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "ultimatedonutsmp2.staff.chat.bypass.delay");
    }

    public boolean isFilterBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "ultimatedonutsmp2.staff.chat.bypass.filter");
    }
