...
public class PunishmentManager {
    ...
    public static final String VIEW_PERMISSION = "ultimatedonutsmp2.staff.punishments.view";
    public static final String DELETE_PERMISSION = "ultimatedonutsmp2.staff.punishments.delete";
    private static final Pattern MINECRAFT_USERNAME = Pattern.compile("^[A-Za-z0-9_]{3,16}$");

    private final UltimateDonutSmp2 plugin;

    public PunishmentManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    public Optional<PunishmentRecord> getActiveRecord(UUID targetUuid, String targetName, PunishmentType type) {
        ...
        List<PunishmentRecord> records = getHistory(
                ...
                1,
                0,
                new PunishmentQuery(type, com.bx.ultimateDonutSmp2.models.PunishmentFilterState.ACTIVE, null)
        );
