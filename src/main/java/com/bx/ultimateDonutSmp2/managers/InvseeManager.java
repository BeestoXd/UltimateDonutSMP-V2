...
import com.bx.ultimateDonutSmp2.invsee.InvseeHolder;
import com.bx.ultimateDonutSmp2.invsee.InvseeSession;
...
public class InvseeManager {
    ...
    public InvseeManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getViewPermission() {
        return getConfig().getString("INVSEE.VIEW-PERMISSION", "ULTIMATEDONUTSMP2.STAFF.INVSEE");
    }

    public String getModifyPermission() {
        return getConfig().getString("INVSEE.MODIFY-PERMISSION", "ULTIMATEDONUTSMP2.STAFF.INVSEE.MODIFY");
    }

    public String getAdminPermission() {
        return getConfig().getString("INVSEE.ADMIN-PERMISSION", "ULTIMATEDONUTSMP2.ADMIN.INVSEE");
    }
