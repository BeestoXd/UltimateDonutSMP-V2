...
public class MaintenanceManager {
    ...
    private static final String REDIS_MAINTENANCE_CHANNEL = "ultimatedonutsmp2:maintenance";
    ...
    public MaintenanceManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    ...
    public void startMaintenance(long durationMillis) {
        ...
        String bypassPerm = config.getString("MAINTENANCE.BYPASS_PERMISSION", "ULTIMATEDONUTSMP2.ADMIN.MAINTENANCE.BYPASS");
        String enteringMessage = config.getString("MAINTENANCE.MESSAGES.ENTERING", "&e[Maintenance] &7server is entering maintenance. Moving you to the lobby...");
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            if (player.hasPermission(bypassPerm)) {
                String bypassJoinMsg = config.getString("MAINTENANCE.MESSAGES.BYPASS_JOIN", "&e[Maintenance] &7you joined while maintenance mode is active.");
