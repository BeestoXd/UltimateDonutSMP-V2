...
public class KeyAllManager {
    ...
    public KeyAllManager(UltimateDonutSmp2 plugin) {
        this.plugin = plugin;
    }
    ...
    private void executeSingleCommand(String command, Player player, SelectedKeyReward reward) {
        ...
        if (checkLower.startsWith("crate keyall") || checkLower.startsWith("ultimatedonutsmp2:crate keyall") || checkLower.startsWith("keyall")) {
