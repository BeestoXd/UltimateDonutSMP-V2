...
public class PlayerData {
    ...
    private TwoChoice advancementMessagesChoice;
    ...
    private boolean sellShulkersEnabled = true;
    private boolean privateTransactionsEnabled;
    private ScoreboardStyle scoreboardStyle = ScoreboardStyle.MODERN;
    ...
    public PlayerData(UUID uuid, String username) {
        ...
        this.advancementMessagesChoice = TwoChoice.FRIENDS_FOLLOWED;
        ...
        this.privateTransactionsEnabled = false;
    ...
    public TwoChoice getAdvancementMessagesChoice() {
        return advancementMessagesChoice;
    }

    public void setAdvancementMessagesChoice(TwoChoice advancementMessagesChoice) {
        this.advancementMessagesChoice = advancementMessagesChoice;
        dirty = true;
    }

    public boolean isAdvancementMessagesEnabled() {
        return advancementMessagesChoice != TwoChoice.OFF;
    }

    public void setAdvancementMessagesEnabled(boolean advancementMessagesEnabled) {
        this.advancementMessagesChoice = advancementMessagesEnabled
                ? TwoChoice.FRIENDS_FOLLOWED
                : TwoChoice.OFF;
        dirty = true;
    }
    ...
    public boolean isSellShulkersEnabled() {
        return sellShulkersEnabled;
    }

    public void setSellShulkersEnabled(boolean sellShulkersEnabled) {
        this.sellShulkersEnabled = sellShulkersEnabled;
        dirty = true;
    }

    public boolean isPrivateTransactionsEnabled() {
        return privateTransactionsEnabled;
    }

    public void setPrivateTransactionsEnabled(boolean privateTransactionsEnabled) {
        this.privateTransactionsEnabled = privateTransactionsEnabled;
        dirty = true;
    }

    public ScoreboardStyle getScoreboardStyle() {
        return scoreboardStyle == null ? ScoreboardStyle.MODERN : scoreboardStyle;
    }

    public void setScoreboardStyle(ScoreboardStyle scoreboardStyle) {
        this.scoreboardStyle = scoreboardStyle == null ? ScoreboardStyle.MODERN : scoreboardStyle;
        dirty = true;
    }
}
