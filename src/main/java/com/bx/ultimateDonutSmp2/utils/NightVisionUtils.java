...
public final class NightVisionUtils {
    ...
    public static boolean isEnabled(UltimateDonutSmp2 plugin, Player player) {
    ...
    public static boolean toggle(UltimateDonutSmp2 plugin, Player player) {
        boolean enabled = !isEnabled(plugin, player);
        setEnabled(plugin, player, enabled);
        return enabled;
    }

    public static void setEnabled(UltimateDonutSmp2 plugin, Player player, boolean enabled) {
        PlayerData data = plugin.getPlayerDataManager().get(player);
        if (data != null) {
    ...
    public static void restoreIfEnabled(UltimateDonutSmp2 plugin, Player player) {
