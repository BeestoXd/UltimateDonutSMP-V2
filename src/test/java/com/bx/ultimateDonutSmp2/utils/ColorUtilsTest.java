...
class ColorUtilsTest {
    ...
    void testUnknownTagsAreLeftAlone() {
        // menus.yml and languages/*.yml are full of these; swallowing them would gut every usage line.
    ...
    @Test
    void testRomanNumeralsPreservedFromTitleCase() {
        assertEquals("§fI", ColorUtils.colorize("&fI"));
        assertEquals("§fII", ColorUtils.colorize("&fII"));
        assertEquals("§fIII", ColorUtils.colorize("&fIII"));
        assertEquals("§fIV", ColorUtils.colorize("&fIV"));
        assertEquals("§fV", ColorUtils.colorize("&fV"));
        assertEquals("§aII", ColorUtils.colorize("&aII"));
        assertEquals("§aIII", ColorUtils.colorize("&aIII"));
        assertEquals("§aIV", ColorUtils.colorize("&aIV"));
        assertEquals("§aV", ColorUtils.colorize("&aV"));
    }
}
