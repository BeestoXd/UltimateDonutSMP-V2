...
class EcseeConfigurationTest {
    ...
    void bundledCommandPermissionAndSettingsArePresent() throws Exception {
        ...
        assertTrue(plugin.getBoolean(
                "permissions.ultimatedonutsmp2.admin.children.ultimatedonutsmp2.admin.ecsee"
        ));
        assertEquals(
                "op",
                plugin.getString("permissions.ultimatedonutsmp2.admin.ecsee.default")
        );
