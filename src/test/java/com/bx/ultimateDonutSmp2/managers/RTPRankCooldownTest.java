...
class RTPRankCooldownTest {
    ...
    private UltimateDonutSmp2 createMockPlugin(YamlConfiguration rtpConfig) throws Exception {
        ...
        Field tmField = UltimateDonutSmp2.class.getDeclaredField("teleportManager");
    ...
    private YamlConfiguration baseConfig() {
        ...
        rtpConfig.set("SETTINGS.RANK-COOLDOWNS.PERMISSIONS.ultimatedonutsmp2.rtp.cooldown.vip++", 3);
        rtpConfig.set("SETTINGS.RANK-COOLDOWNS.PERMISSIONS.ultimatedonutsmp2.rtp.cooldown.vip+", 10);
        rtpConfig.set("SETTINGS.RANK-COOLDOWNS.PERMISSIONS.ultimatedonutsmp2.rtp.cooldown.vip", 15);
        return rtpConfig;
    }
    ...
    void testCooldownResolvedFromConfiguredPermissionMap() throws Exception {
        ...
        Player vip = createMockPlayer(UUID.randomUUID(), "VIP", Set.of("ultimatedonutsmp2.rtp.cooldown.vip"));
        Player vipPlus = createMockPlayer(UUID.randomUUID(), "VIPPlus", Set.of("ultimatedonutsmp2.rtp.cooldown.vip+"));
        Player vipPlusPlus = createMockPlayer(UUID.randomUUID(), "VIPPlusPlus", Set.of("ultimatedonutsmp2.rtp.cooldown.vip++"));
    ...
    void testCooldownResolvedFromNumberedPermission() throws Exception {
        ...
        Player numeric = createMockPlayer(UUID.randomUUID(), "Numeric", Set.of("ultimatedonutsmp2.rtp.cooldown.7"));
    ...
    void testLowestValueWinsAcrossStackedPermissions() throws Exception {
        ...
        Player stacked = createMockPlayer(UUID.randomUUID(), "Stacked", Set.of(
                "ultimatedonutsmp2.rtp.cooldown.vip",
                "ultimatedonutsmp2.rtp.cooldown.vip+",
                "ultimatedonutsmp2.rtp.cooldown.5"
        ));
    ...
    void testPermissionOverridesWorldCooldownInBothDirections() throws Exception {
        ...
        Player slower = createMockPlayer(UUID.randomUUID(), "Slower", Set.of("ultimatedonutsmp2.rtp.cooldown.60"));
        assertEquals(60, rtpManager.getPlayerCooldownSeconds(slower, "world"));

        Player faster = createMockPlayer(UUID.randomUUID(), "Faster", Set.of("ultimatedonutsmp2.rtp.cooldown.5"));
    ...
    void testZeroPermissionRemovesCooldownEntirely() throws Exception {
        ...
        Player bypass = createMockPlayer(UUID.randomUUID(), "Bypass", Set.of("ultimatedonutsmp2.rtp.cooldown.0"));
    ...
    void testMalformedNumberedPermissionIsIgnored() throws Exception {
        ...
        Player malformed = createMockPlayer(UUID.randomUUID(), "Malformed", Set.of(
                "ultimatedonutsmp2.rtp.cooldown.abc",
                "ultimatedonutsmp2.rtp.cooldown.-5",
                "ultimatedonutsmp2.rtp.cooldown."
        ));
    ...
    void testDisabledRankCooldownsFallBackToWorldSetting() throws Exception {
        ...
        Player vipPlusPlus = createMockPlayer(UUID.randomUUID(), "VIPPlusPlus", Set.of(
                "ultimatedonutsmp2.rtp.cooldown.vip++",
                "ultimatedonutsmp2.rtp.cooldown.1"
        ));
