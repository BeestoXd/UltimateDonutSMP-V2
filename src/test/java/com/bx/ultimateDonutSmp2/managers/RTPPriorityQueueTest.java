...
class RTPPriorityQueueTest {
    ...
    void testPriorityResolutionFromConfig() throws Exception {
        ...
        rtpConfig.set("SETTINGS.PRIORITY-QUEUE.PERMISSIONS.ultimatedonutsmp2.rtp.priority.vip++", 30);
        rtpConfig.set("SETTINGS.PRIORITY-QUEUE.PERMISSIONS.ultimatedonutsmp2.rtp.priority.vip+", 20);
        rtpConfig.set("SETTINGS.PRIORITY-QUEUE.PERMISSIONS.ultimatedonutsmp2.rtp.priority.vip", 10);
        ...
        Player vip = createMockPlayer(UUID.randomUUID(), "PlayerVIP", Set.of("ultimatedonutsmp2.rtp.priority.vip"));
        Player vipPlusPlus = createMockPlayer(UUID.randomUUID(), "PlayerVIPPlusPlus", Set.of("ultimatedonutsmp2.rtp.priority.vip++"));
        Player customNumeric = createMockPlayer(UUID.randomUUID(), "PlayerNumeric", Set.of("ultimatedonutsmp2.rtp.priority.50"));
    ...
    void testPriorityQueueOrderingAndPosition() throws Exception {
        ...
        Player vip = createMockPlayer(vipId, "VIP", Set.of("ultimatedonutsmp2.rtp.priority.vip"));
        Player vipPlusPlus = createMockPlayer(vipPlusPlusId, "VIP++", Set.of("ultimatedonutsmp2.rtp.priority.vip++"));
    ...
    void testPriorityQueueDisabled() throws Exception {
        ...
        Player player = createMockPlayer(UUID.randomUUID(), "Player1", Set.of("ultimatedonutsmp2.rtp.priority.vip++"));
