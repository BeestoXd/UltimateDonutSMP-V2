    ...
    void offlinePlayerLookupDoesNotCloseConnectionAndLoadsPlayer() throws Exception {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite::memory:");
            ...
            statement.execute("CREATE TABLE players ("
                    ...
                    + "combat_timer_enabled INTEGER DEFAULT 1, sell_shulkers_enabled INTEGER DEFAULT 1, "
            ...
            com.bx.ultimateDonutSmp2.models.PlayerData loaded = manager.loadPlayer(foundUuid);
