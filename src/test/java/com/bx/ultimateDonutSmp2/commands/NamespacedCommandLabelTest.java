...
import com.bx.ultimateDonutSmp2.managers.CombatManager;
import com.bx.ultimateDonutSmp2.managers.ConfigManager;
import com.bx.ultimateDonutSmp2.managers.HomeManager;
...
class NamespacedCommandLabelTest {
    ...
    void namespacedLabelSellsTheHeldStackToo() throws Exception {
        RecordingShopManager shop = runSell("ultimatedonutsmp2:sellhand");
        assertTrue(shop.sold, "/ultimatedonutsmp2:sellhand has to reach ShopManager.sellInventory");
    }
    ...
    void namespacedLabelSavesAHomeToo() throws Exception {
        RecordingHomeManager homes = runHome("ultimatedonutsmp2:sethome");
        assertTrue(homes.saved, "/ultimatedonutsmp2:sethome has to save a home rather than teleport");
    }
    ...
    private RecordingShopManager runSell(String label) throws Exception {
        ...
        set(UltimateDonutSmp2.class, plugin, "shopManager", shop);
    ...
    private RecordingHomeManager runHome(String label) throws Exception {
        ...
        set(UltimateDonutSmp2.class, plugin, "combatManager", new CombatManager(plugin));
        set(UltimateDonutSmp2.class, plugin, "homeManager", homes);
    ...
    public static class RecordingShopManager extends ShopManager {
        ...
        public RecordingShopManager(UltimateDonutSmp2 plugin) {
            super(plugin);
        }
    ...
    public static class RecordingHomeManager extends HomeManager {
        ...
        public RecordingHomeManager(UltimateDonutSmp2 plugin) {
            super(plugin);
        }
