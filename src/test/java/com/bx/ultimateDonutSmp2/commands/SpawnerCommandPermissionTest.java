...
class SpawnerCommandPermissionTest {
    ...
    void spawnerCommandIsReachableByPlayersWhileAdminWorkStaysOp() throws Exception {
        ...
        assertEquals("true", plugin.getString("permissions/ultimatedonutsmp2.command.spawner/default"));
        assertEquals("op", plugin.getString("permissions/ultimatedonutsmp2.admin.spawner/default"));
    }
}
