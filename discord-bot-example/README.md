# UltimateDonutSmp2 Discord Bot Example
...
```env
DB_TYPE=sqlite
SQLITE_FILE=../plugins/UltimateDonutSmp2/data/data.db
```
...
MYSQL_PORT=3306
MYSQL_DATABASE=ultimatedonutsmp2
MYSQL_USER=root
...
MONGODB_DATABASE=ultimatedonutsmp2
